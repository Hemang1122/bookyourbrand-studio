...
```ts
import { useCreateNewProject, useGetMyProjects, useGetPublicClients, useUpdateProjectStatus } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetPublicClients();
...
```js
import { createNewProject, getMyProjects, getPublicClients, updateProjectStatus } from '@dataconnect/generated';
