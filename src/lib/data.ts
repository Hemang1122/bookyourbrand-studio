...
export const users: User[] = [
  { id: 'user-admin', uid: 'user-admin', name: 'Niddhi Sharma', email: 'niddhi@example.com', avatar: 'avatar-2', role: 'admin', username: 'niddhi' },
  { id: 'user-11', uid: 'user-11', name: 'Himmat Singh', email: 'himmat@example.com', avatar: 'avatar-3', role: 'team', username: 'himmat' },
  { 
