...
import { WorkTimer } from '../dashboard/components/work-timer';
        ...
        <>
            <div className="space-y-8">
                <div className="space-y-2">
                    <h2 className="text-3xl font-bold tracking-tight">Work Timer & History</h2>
                    <p className="text-muted-foreground">
                        Track your work hours and review your past sessions.
                    </p>
                </div>
