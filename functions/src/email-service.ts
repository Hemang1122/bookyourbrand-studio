...
export async function sendTaskAssignedEmail(params: TaskNotificationParams) {
...
export async function sendProjectChatMessageEmail(params: ChatMessageNotificationParams) {
